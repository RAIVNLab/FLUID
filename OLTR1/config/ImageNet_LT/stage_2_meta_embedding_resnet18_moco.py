...
training_opt['log_dir'] = 'OLTR1/logs/ImageNet_LT/meta_embedding'
...
training_opt['sampler'] = {'type': 'ClassAwareSampler', 'def_file': 'OLTR1/data/ClassAwareSampler.py',
                           'num_samples_cls': 4}
...
networks['feat_model'] = {'def_file': 'OLTR1/models/ResNet18_mocoFeature.py',
...
criterions['FeatureLoss'] = {'def_file': 'OLTR1/loss/DiscCentroidsLoss.py', 'loss_params': feat_loss_param,
